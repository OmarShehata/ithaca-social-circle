const d=function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))n(t);new MutationObserver(t=>{for(const e of t)if(e.type==="childList")for(const r of e.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function i(t){const e={};return t.integrity&&(e.integrity=t.integrity),t.referrerpolicy&&(e.referrerPolicy=t.referrerpolicy),t.crossorigin==="use-credentials"?e.credentials="include":t.crossorigin==="anonymous"?e.credentials="omit":e.credentials="same-origin",e}function n(t){if(t.ep)return;t.ep=!0;const e=i(t);fetch(t.href,e)}};d();var f=document.getElementById("emoji-rain"),l=["\u{1F600}","\u{1F601}","\u{1F604}","\u{1F60A}","\u{1F60E}","\u{1F60D}","\u{1F642}","\u{1F917}","\u{1F929}","\u{1F61D}","\u{1F973}","\u{1F920}","\u{1F638}","\u{1F438}","\u{1F43C}","\u{1F428}","\u{1F414}","\u{1F40C}","\u{1F41D}","\u{1F57A}","\u{1F483}","\u{1F64C}","\u{1FAF6}","\u{1F44B}","\u{1F46F}","\u{1F388}","\u2728","\u{1F389}","\u{1F38A}","\u{1F3C6}","\u{1FAA9}","\u{1FA87}","\u{1F37A}","\u{1F37B}","\u{1F942}","\u{1F37E}","\u{1F338}","\u{1F3F5}\uFE0F","\u{1F33A}","\u{1FA82}","\u{1F3D8}\uFE0F","\u{1F31D}","\u{1F31E}","\u{1F31F}","\u2B50","\u{1F308}","\u{1F496}","\u{1F4AB}","\u{1F4AF}","\u2B55"],a=[];function m(s,o,i){setTimeout(function(){var n=new u(o[0]+Math.random()*o[1],-30,i,{x:-.15+Math.random()*.3,y:1+Math.random()*1},o);a.push(n)},s)}function u(s,o,i,n,t){var e=this;this.x=s,this.y=o,this.color=i,this.v=n,this.range=t,this.element=document.createElement("span"),this.element.style.opacity=0,this.element.style.position="absolute",this.element.style.fontSize="26px",this.element.style.color="hsl("+(Math.random()*360|0)+",80%,50%)",this.element.innerHTML=i,f.appendChild(this.element),this.update=function(){e.y>window.innerHeight&&(e.y=-30,e.x=e.range[0]+Math.random()*e.range[1]),e.y+=e.v.y,e.x+=e.v.x,this.element.style.opacity=1,this.element.style.transform="translate3d("+e.x+"px, "+e.y+"px, 0px)",this.element.style.webkitTransform="translate3d("+e.x+"px, "+e.y+"px, 0px)",this.element.style.mozTransform="translate3d("+e.x+"px, "+e.y+"px, 0px)"}}function c(){for(var s in a)a[s].update();requestAnimationFrame(c)}function b(){for(var s=0;s<15;s++){const o=window.innerWidth;for(let i=0;i<o;i+=200)m(s*150,[i,300],l[Math.floor(Math.random()*l.length)])}c()}window.startEmojiRain=b;const p="signup-form";class v extends HTMLElement{constructor(){super()}connectedCallback(){let o=document.createElement("div");o.innerHTML=`	
        <style>
        ${h}
        </style>
        ${y}
		`,this.appendChild(o);const i=document.createElement("script");i.src="https://sibforms.com/forms/end-form/build/main.js",i.setAttribute("defer",""),this.appendChild(i),window.REQUIRED_CODE_ERROR_MESSAGE="Please choose a country code",window.LOCALE="en",window.EMAIL_INVALID_MESSAGE=window.SMS_INVALID_MESSAGE="The information provided is invalid. Please review the field format and try again.",window.REQUIRED_ERROR_MESSAGE="This field cannot be left blank. ",window.GENERIC_INVALID_MESSAGE="The information provided is invalid. Please review the field format and try again.",window.translation={common:{selectedList:"{quantity} list selected",selectedLists:"{quantity} lists selected"}},window.AUTOHIDE=Boolean(0);let n=null;document.querySelector("#submit-btn").onclick=()=>{clearInterval(n),n=setInterval(()=>{const t=document.querySelector("#success-message").classList.length==2;console.log({isSuccess:t}),t&&(clearInterval(n),console.log("Emoji rain!"),startEmojiRain())},100)}}}var h=`
...
</div>`;window.customElements.define(p,v);
