...
class SignupForm extends HTMLElement {
	...
	connectedCallback() {
      ...
      document.querySelector("#submit-btn").onclick = () => {
         ...
         // Poll for success and do emoji rain
         intervalId = setInterval(() => {
            const isSuccess = document.querySelector("#success-message").classList.length == 2
            console.log({ isSuccess })

            if (isSuccess) {
               clearInterval(intervalId)
               console.log("Emoji rain!")
               startEmojiRain()
            }
         }, 100)
      }
...
var FORM_HTML = `<div class="sib-form">
